...
function BlockManagerS:constructor(parent)
	...
	self.blockModelIDs["woodBlockOAK"] = 1858
	self.blockModelIDs["leavesBlockOAK"] = 1859
	...
	self.blockTypeAttributes["woodBlockOAK"] = {life = 1800, needsUpdate = "true", color = {r = 80, g = 35, b = 5, a = 200}}
	self.blockTypeAttributes["leavesBlockOAK"] = {life = 250, needsUpdate = "true", color = {r = 35, g = 128, b = 35, a = 200}}
